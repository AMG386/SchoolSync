                        ...
                        <tbody>
                            @foreach ($usergroups as $usergroup)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex flex-column">
                                                <a href="{{ route('usergroups.show', $usergroup->id) }}"
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 btnAction"
                                                    data-url="usergroups/{{ $usergroup->id }}/edit" data-redirect="usergroups">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 btndelete"
                                                    data-url='usergroups/{{ $usergroup->id }}' data-actiontype="redirect"
                                    ...
                                    {{-- 
                                <td class="text-end">
                                    <a href="{{ route('employees.show',$usergroup->id) }}"
                                    ...
                                    <button type="button" class="btn btn-sm btn-light-warning me-2 btnEdit"
                                        ...
                                        data-url="{{ route('employees.edit',$usergroup->id) }}" data-bs-toggle="modal"
                                    ...
                                    <button type="button" class="btn btn-sm btn-light-danger btnDelete"
                                        data-id="{{$usergroup->id }}"
                                        data-url="{{ route('employees.destroy',$usergroup->id) }}"
