        ...
        <div class="tab-content" id="studentTabContent">
            ...
            <div class="tab-pane fade" id="documents" role="tabpanel">
                <div class="row g-3">
                    ...
                    @if($student->photo)
                        <div class="col-md-4">
                            <img src="{{ asset($student->photo) }}" alt="Student Photo" class="rounded-circle border" width="100">
                        </div>
                    @endif
                    @include('layouts.common._col-input', [
                        'type' => 'file',
                    ...
                    @if($student->aadhaar_card)
                        <div class="col-md-4">
                            <a href="{{ asset($student->aadhaar_card) }}" target="_blank">View Current Aadhaar</a>
                        </div>
                    @endif
            ...
            <div class="tab-pane fade" id="remarks" role="tabpanel">
                <div class="row g-3">
                    @include('layouts.common._col-input', [
                        ...
                        'label' => 'Remarks',
                        'class' => 'col-md-12',
                        'value' => old('remarks', $student->remarks)
                    ])
                </div>
            </div>
        </div>
