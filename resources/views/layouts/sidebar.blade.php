...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
      <a href="{{ url('/') }}">
    <span class="app-sidebar-logo-default fw-bold fs-2 text-white">Easy School</span>
    <span class="app-sidebar-logo-minimize fw-bold fs-4 text-white">ES</span>
      </a>
        <!--end::Logo image-->
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu"
                    ...
                    <div class="menu-item">
                     ...
                     <div class="menu-item">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{route('guardians.index')}}">
                                <span class="menu-icon">
